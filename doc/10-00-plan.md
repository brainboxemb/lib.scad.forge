...
main. The current owner step is to publish that integrated baseline as the next
patch release from `v0.3.0`.

Issue #30 (`fg_overlap_mm()` retirement) remains a separate Forge API decision
and is intentionally not part of this tooling-integration release.
